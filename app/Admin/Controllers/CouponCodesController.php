...
class CouponCodesController extends Controller
{
    ...
    protected function form()
    {
        return Admin::form(CouponCode::class, function (Form $form) {
            ...
            $form->radio('type', '优惠券类型')->options(CouponCode::$typeMap)->rules('required');
            ...
            $form->text('min_amount', '最低金额')->rules('required|numeric|min:1');
            ...
            $form->saving(function(Form $form) {
                if(!$form->code) {
                    $form->code = CouponCode::generateAvailableCode();
                }
            });
        });
    }
